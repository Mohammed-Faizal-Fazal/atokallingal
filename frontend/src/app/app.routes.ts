...
export const routes: Routes = [
  ...
  { path: 'about', loadComponent: () => import('./pages/about/about.component').then(m => m.AboutComponent),
    title: 'About Kallingal Group | Our Story & Legacy in Trivandrum',
    data: { description: 'The Kallingal Group story since 1985 - Bajaj dealer, Chetak EV, authorised Tata service, 19+ showrooms across Trivandrum, and the brands we carry.' } },
