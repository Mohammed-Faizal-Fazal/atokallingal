...
public class ApiRouter {
  ...
  public RouterFunction<ServerResponse> routes(ApiHandler h) {
    return route(GET("/api/showrooms"), h::listShowrooms)
      ...
      .andRoute(GET("/api/about-milestones"), h::listAboutMilestones)
      .andRoute(GET("/api/about-brands"), h::listAboutBrands)
      ...
      .andRoute(GET("/api/admin/about-milestones"), h::listAdminAboutMilestones)
      .andRoute(POST("/api/admin/about-milestones"), h::saveAboutMilestone)
      .andRoute(DELETE("/api/admin/about-milestones/{id}"), h::deleteAboutMilestone)
      .andRoute(GET("/api/admin/about-brands"), h::listAdminAboutBrands)
      .andRoute(POST("/api/admin/about-brands"), h::saveAboutBrand)
      .andRoute(DELETE("/api/admin/about-brands/{id}"), h::deleteAboutBrand)
      ...
      .andRoute(GET("/api/admin/applications/{id}/cv"), h::downloadCv)
